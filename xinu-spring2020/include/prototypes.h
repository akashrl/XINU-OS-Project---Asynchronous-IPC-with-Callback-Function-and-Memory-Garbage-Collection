...
extern syscall cbregister(void (* fp)(void), umsg32 *mbufptr); // Added for Lab 5, Part 3

/* in file userbuf.c */
extern void userbuf(void); // Added for Lab 5, Part 3

extern umsg32 ubuffer; // Added for Lab 5, Part 3

/* Added for Lab 5, Section 4 */
extern void meminsert(struct inusememblk *hdptr, char *memptr);

/* Added for Lab 5, Section 4 */
void memextract(struct inusememblk *hdptr, char *memptr);

/* Added for Lab 5, Section 4 */
extern bool8 memblockkflag;
